...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo,Integer userId,String path){
        ...
        switch (result.getTradeStatus()) {
            ...
            case UNKNOWN:
                ...
                return ServerResponse.createByErrorMessage("预下单状态未知");
    ...
    private OrderVo assembleOrderVo(Order order,List<OrderItem> orderItemList){
        ...
        if (shipping!=null){
            ...
            orderVo.setShippingVo(assembleShippngVo(shipping));
        }
    ...
    private ShippingVo assembleShippngVo(Shipping shipping){
    ...
    private ServerResponse<List<OrderItem>> getCartOrderItem(Integer userId,List<Cart> cartList){
        ...
        for (Cart cartItem:cartList){
            ...
            if (Const.ProductStatusEnum.ON_SALE.getCode()!=product.getStatus()){
                return ServerResponse.createByErrorMessage("产品"+product.getName()+"产品不是在线售卖状态");
            }
